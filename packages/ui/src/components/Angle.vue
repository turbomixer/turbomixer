...
<template>
  <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512" style="animation: 0.5s;" :style="{transform:'translate(-3px,0) rotate('+(props.enabled ? 0 : 90)+'deg) translate(3px,0px)'}">
