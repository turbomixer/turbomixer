...
export function createBlockly():typeof Blockly{
    ...
    const setTimeout = function(cb:TimerHandler,t:number,...args:any[]){
        return _window.setTimeout(cb,t,...args);
    }

    const setInterval = function(cb:TimerHandler,t:number,...args:any[]){
        return _window.setTimeout(cb,t,...args);
    }
